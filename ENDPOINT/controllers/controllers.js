...
const obtenerCars = async(request,response)=>{
    const cars= await conexion.query("SELECT * FROM cars")
    console.log(cars)
    response.json(cars.rows)
}
...
export {hola , holaNombre,suma , apiBody, obtenerCars}